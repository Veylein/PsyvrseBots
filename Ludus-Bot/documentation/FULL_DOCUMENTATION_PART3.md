...
# 3. ZOO COLLECTION SYSTEM

**File:** `cogs/zoo.py` (800 lines)  
**Class:** `Zoo(commands.Cog)`

## Zoo Overview

The Zoo system is a **passive collection mechanic** where players randomly encounter animals while playing other games:

- **15% encounter chance** on game completion
- **60+ unique animals** across 8 game categories
- **3 rarity tiers:** Common (70%), Rare (25%), Legendary (5%)
- **Collection tracking** with counts and discovery dates
- **Filtering system** by source or rarity

---

## Animal Database

**Location:** Lines 16-150
...
**Common:**
- 🦌 Buck - "A majestic deer, the symbol of wealth"
- 🐕 Dog - "Man's best friend and loyal companion"
- 🐈 Cat - "Independent and graceful feline"
- 🐎 Horse - "Swift and noble steed"

**Rare:**
- 🦅 Eagle - "Soaring symbol of freedom"
- 🦊 Fox - "Cunning and clever predator"

**Legendary:**
- 👑 Royal Peacock - "Magnificent bird of luxury"

#### 2. Wizard Wars Animals

**Common:**
- 👺 Goblin - "Mischievous magical creature"
- 🧚 Fairy - "Tiny magical sprite"
- 🦇 Bat - "Nocturnal cave dweller"

**Rare:**
- 🧙 Wizard Owl - "Wise magical companion"
- 🐺 Dire Wolf - "Fierce magical beast"

**Legendary:**
- 🐉 Dragon - "Legendary fire-breathing beast"
- 🦄 Unicorn - "Pure magical horse"

#### 3. D&D Animals

**Common:**
- 🐀 Giant Rat - "Dungeon pest"
- 🕷️ Giant Spider - "Eight-legged horror"

**Rare:**
- 🐉 Wyvern - "Lesser dragon cousin"
- 🦎 Basilisk - "Deadly serpent king"

**Legendary:**
- 🐲 Ancient Dragon - "Most powerful dragon"
- 👹 Demon - "Otherworldly fiend"

#### 4. Mystery Animals

**Common:**
- 🐦‍⬛ Raven - "Mysterious black bird"
- 🐱 Black Cat - "Ominous feline"

**Rare:**
- 🦉 Owl - "Wise night hunter"

**Legendary:**
- 🕵️ Phantom Hound - "Ghostly detective's companion"

#### 5. Gambling Animals

**Common:**
- 🐰 Lucky Rabbit - "Brings good fortune"
- 🐸 Golden Frog - "Symbol of prosperity"

**Rare:**
- 🍀 Four-Leaf Clover Cat - "Ultra lucky feline"

**Legendary:**
- 💰 Money Dragon - "Legendary wealth guardian"

#### 6. Fishing Animals

**Common:**
- 🦭 Seal - "Playful sea mammal"
- 🐧 Penguin - "Flightless arctic bird"
- 🦦 Otter - "Adorable water weasel"
...
**Common:**
- 🐔 Chicken - "Egg-laying farm bird"
- 🐄 Cow - "Gentle milk producer"
- 🐷 Pig - "Pink farm animal"

**Rare:**
- 🦙 Llama - "Exotic farm animal"

**Legendary:**
- 🦚 Rainbow Peacock - "Stunning farm jewel"

#### 8. Time Travel Animals

**Common:**
- 🦕 Triceratops - "Ancient three-horned dinosaur"
- 🦖 Velociraptor - "Fast prehistoric hunter"

**Rare:**
- 🦣 Mammoth - "Ice age giant"
- 🐅 Sabertooth Tiger - "Prehistoric apex predator"
...
**Common:**
- 👽 Alien Pet - "Extraterrestrial creature"

**Rare:**
- 🛸 Space Dog - "Cosmic canine"

**Legendary:**
- 🌌 Cosmic Phoenix - "Immortal space bird"

---

## Encounter System

**Location:** Lines 178-230
...
**Usage Example (in other cogs):**
```python
# After completing a fishing minigame
zoo_cog = self.bot.get_cog("Zoo")
if zoo_cog:
    encounter = zoo_cog.trigger_encounter(user_id, "fishing")
    if encounter:
        if encounter["is_new"]:
            await ctx.send(
                f"🦁 **New Animal Discovered!**\n"
                f"{encounter['animal']['name']} - {encounter['animal']['rarity']}\n"
                f"*{encounter['animal']['description']}*\n"
                f"Added to your zoo!"
            )
        else:
            await ctx.send(
                f"🦁 You found another {encounter['animal']['name']}! "
                f"(Total: {encounter['count']}x)"
            )
```
...
### 1. `L!zoo [filter]` / `/zoo [filter]` - View Collection

**Location:** Lines 232-303

**Display:**
- Total species collected
- Filter status (All, or by source/rarity)
- Animals sorted by rarity then name
- Up to 25 animals per page

**Filtering:**
- By source: `L!zoo fishing`, `L!zoo monopoly`
- By rarity: `L!zoo common`, `L!zoo legendary`
...
⚪ 🐕 Dog
Man's best friend and loyal companion
Source: monopoly | Count: 3x

🔵 🦅 Eagle
Soaring symbol of freedom
Source: monopoly | Count: 1x

🟡 🐉 Dragon
Legendary fire-breathing beast
Source: wizard_wars | Count: 1x
```

### 2. `L!release <animal>` / `/zoo_release <animal>` - Release Animal

**Location:** Lines 305-345

**Purpose:** Remove animal from collection (permanent)

**Implementation:**
```python
async def _release_animal(self, user_id, animal_name, ctx=None, interaction=None):
    """Release animal back into the wild"""
    user_zoo = self.get_user_zoo(user_id)
    ...
    "user_id": {
        "animals": {
            "monopoly_🦌 Buck": {
                "name": "🦌 Buck",
                "rarity": "Common",
                "description": "A majestic deer, the symbol of wealth",
                "source": "monopoly",
                "found_date": "2024-01-15T14:30:00",
                "count": 3
            },
            "wizard_wars_🐉 Dragon": {
                "name": "🐉 Dragon",
                "rarity": "Legendary",
                "description": "Legendary fire-breathing beast",
                "source": "wizard_wars",
                "found_date": "2024-01-20T18:45:00",
                "count": 1
            }
        },
        "total_animals": 15,
        "last_encounter": "2024-01-22T12:00:00"
    }
}
```
...
Zoo encounters are triggered from:

1. **Monopoly** - After completing a game
2. **Wizard Wars** - After battle ends
3. **D&D** - After quest completion
4. **Fishing** - After successful catch
5. **Gambling** - After big wins
6. **Farming** - After harvest
7. **Time Travel** - After time jump
8. **Space** - After space mission

**Example Integration:**
```python
# In fishing.py after successful catch
zoo_cog = self.bot.get_cog("Zoo")
if zoo_cog:
    encounter = zoo_cog.trigger_encounter(user_id, "fishing")
    if encounter and encounter["is_new"]:
        embed.add_field(
            name="🦁 New Animal Discovered!",
            value=f"{encounter['animal']['name']} - {encounter['animal']['rarity']}\n"
                  f"*{encounter['animal']['description']}*",
            inline=False
        )
```
