"""
Disabled helper: migrate_to_db.py

This migration/backfill script was replaced with a placeholder during cleanup.
If you need to run migrations, restore the original file from version control.
"""

if __name__ == "__main__":
    print("migrate_to_db.py has been disabled.")
